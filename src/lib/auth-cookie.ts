...
const COOKIE_NAME = 'sirva_session'

/**
 * Writes the auth session to the sirva_session cookie.
...
/**
 * Clears the sirva_session cookie.
 * Browser-only — guards with typeof window check.
 */
...
/**
 * Reads and parses the sirva_session cookie.
